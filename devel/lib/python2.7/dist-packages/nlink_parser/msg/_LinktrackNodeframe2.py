...
class LinktrackNodeframe2(genpy.Message):
  _md5sum = "08de59942343acd9944807b4be9fc64a"
...
float32 rxRssi
"""
  __slots__ = ['role','id','localTime','systemTime','voltage','pos','eop','vel','angle','q','imuGyro','imuAcc','node']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       role,id,localTime,systemTime,voltage,pos,eop,vel,angle,q,imuGyro,imuAcc,node
