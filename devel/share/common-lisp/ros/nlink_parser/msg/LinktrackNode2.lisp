...
(cl:defmethod fpRssi-val ((m <LinktrackNode2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nlink_parser-msg:fpRssi-val is deprecated.  Use nlink_parser-msg:fpRssi instead.")
  (fpRssi m))

(cl:ensure-generic-function 'rxRssi-val :lambda-list '(m))
(cl:defmethod rxRssi-val ((m <LinktrackNode2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nlink_parser-msg:rxRssi-val is deprecated.  Use nlink_parser-msg:rxRssi instead.")
  (rxRssi m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LinktrackNode2>)))
  ...
  "3d1b1e4e841a37dd7a0f4fb3c8d8faa0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LinktrackNode2)))
  "Returns md5sum for a message object of type 'LinktrackNode2"
  "3d1b1e4e841a37dd7a0f4fb3c8d8faa0")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackNode2>)))
  ...
  (cl:format cl:nil "uint8 role~%uint8 id~%float32 dis~%float32 fpRssi~%float32 rxRssi~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackNode2)))
  "Returns full string definition for message of type 'LinktrackNode2"
  (cl:format cl:nil "uint8 role~%uint8 id~%float32 dis~%float32 fpRssi~%float32 rxRssi~%~%~%"))
