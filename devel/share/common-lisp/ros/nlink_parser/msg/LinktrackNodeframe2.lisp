...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNodeframe2>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNodeframe2)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nlink_parser-msg:<LinktrackNodeframe2> is deprecated: use nlink_parser-msg:LinktrackNodeframe2 instead.")))
...
(cl:defmethod localTime-val ((m <LinktrackNodeframe2>))
...
(cl:defmethod systemTime-val ((m <LinktrackNodeframe2>))
...
(cl:defmethod pos-val ((m <LinktrackNodeframe2>))
...
(cl:defmethod eop-val ((m <LinktrackNodeframe2>))
...
(cl:defmethod vel-val ((m <LinktrackNodeframe2>))
...
(cl:defmethod angle-val ((m <LinktrackNodeframe2>))
...
(cl:defmethod q-val ((m <LinktrackNodeframe2>))
...
(cl:defmethod imuGyro-val ((m <LinktrackNodeframe2>))
...
(cl:defmethod imuAcc-val ((m <LinktrackNodeframe2>))
...
(cl:defmethod node-val ((m <LinktrackNodeframe2>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackNodeframe2>)))
  ...
  "nlink_parser/LinktrackNodeframe2")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackNodeframe2)))
  "Returns string type for a message object of type 'LinktrackNodeframe2"
  "nlink_parser/LinktrackNodeframe2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LinktrackNodeframe2>)))
  ...
  "08de59942343acd9944807b4be9fc64a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LinktrackNodeframe2)))
  "Returns md5sum for a message object of type 'LinktrackNodeframe2"
  "08de59942343acd9944807b4be9fc64a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackNodeframe2>)))
  ...
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 localTime~%uint32 systemTime~%float32 voltage~%float32[3] pos~%float32[3] eop~%float32[3] vel~%float32[3] angle~%float32[4] q~%float32[3] imuGyro~%float32[3] imuAcc~%LinktrackNode2[] node~%~%================================================================================~%MSG: nlink_parser/LinktrackNode2~%uint8 role~%uint8 id~%float32 dis~%float32 fpRssi~%float32 rxRssi~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackNodeframe2)))
  "Returns full string definition for message of type 'LinktrackNodeframe2"
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 localTime~%uint32 systemTime~%float32 voltage~%float32[3] pos~%float32[3] eop~%float32[3] vel~%float32[3] angle~%float32[4] q~%float32[3] imuGyro~%float32[3] imuAcc~%LinktrackNode2[] node~%~%================================================================================~%MSG: nlink_parser/LinktrackNode2~%uint8 role~%uint8 id~%float32 dis~%float32 fpRssi~%float32 rxRssi~%~%~%"))
