...
if("TRUE" STREQUAL "TRUE")
  set(track_pkg_SOURCE_PREFIX /home/nvidia/uav_ws/src/track_pkg)
  set(track_pkg_DEVEL_PREFIX /home/nvidia/uav_ws/devel)
  ...
  set(track_pkg_INSTALL_PREFIX /home/nvidia/uav_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'track_pkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/uav_ws/src/track_pkg/${idir}'.  ${_report}")
    endif()
